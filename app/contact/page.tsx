          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 max-w-6xl mx-auto">
            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 rounded-xl shadow-lg">
              ...
              <form id="contact-form" onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                ...
                {submitStatus && (
                  <div className={`p-3 sm:p-4 rounded-lg text-center font-medium text-sm sm:text-base ${submitStatus.includes('envoyée') ? 'bg-green-100 text-green-700 border border-green-200' : 'bg-red-100 text-red-700 border border-red-200'}`}>
                    {submitStatus}
                  </div>
                )}
              </form>
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div className="flex items-start">
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="font-semibold text-gray-900 mb-1 text-sm sm:text-base">Appelez-nous maintenant</p>
                      <a href="tel:+15142698119" className="text-blue-600 hover:text-blue-700 cursor-pointer transition-colors duration-200 text-sm sm:text-base lg:text-lg break-all">
                        +1 (514) 269-8119
                      </a>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <a href="mailto:luminacleanservice@gmail.com" className="text-blue-600 hover:text-blue-700 cursor-pointer transition-colors duration-200 text-sm sm:text-base break-all">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="font-semibold text-gray-900 mb-1 text-sm sm:text-base">Horaires d'intervention</p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="font-semibold text-gray-900 mb-1 text-sm sm:text-base">Zone de service</p>
                      <p className="text-gray-600 text-sm sm:text-base">Laval, Montréal, Longueuil, Brossard</p>
                    </div>
                  </div>
                </div>
              </div>
